...
<body>
	...
	<form action="boardFnA" method="post"
		...
		<label for="title"><img
			src="././resources/images/boardlogo2_2.png" alt="제목"></label> <input
			type="text" name="title" style="width: 800px" id="title" required />
		<br /> <label for="content" style="display: inline;"><img
		...
		<br />
		<c:if test="${not empty loginUserid}">
			<label for="userid"><img
				src="././resources/images/boardlogo4_4.png" alt="아이디"></label>
			<input type="text" name="userid" id="userid" value="${loginUserid}"
				readonly="readonly" />
		</c:if>
