...
<body>
	...
	<div class="container" style="width: 930px;">
		<h2>
			<img alt="F&A" src="././resources/images/fna.png">
		</h2>
		<br />
		<div class="panel-group" id="accordion">
				...
				<div class="panel-heading"
					...
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							href="#collapse1" style="font-family: 배달의민족 주아;">1. 회원가입
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;▼ </a>
					</h4>
				</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading"
					...
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							href="#collapse2" style="font-family: 배달의민족 주아;">2. 포인트
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;▼</a>
					</h4>
				</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading"
					...
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							href="#collapse3" style="font-family: 배달의민족 주아;">3.
							문의사항&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;▼</a>
					</h4>
				</div>
	...
	<div class="container" style="width: 930px;">
		<h2>
			<img alt="F&A" src="././resources/images/qna.png">
		</h2>
		<ul style="display: inline;">

			<c:if test="${empty loginUserid }">
				<a href="" class="btn btn-primary" onclick="boardregister()"
					style="background-color: #1c1637; border: none; font-family: 배달의민족 주아; color: white; float: right;">
					새 글 작성</a>
			</c:if>
			<c:if test="${not empty loginUserid}">
				<a href="boardregister" class="btn btn-primary"
					onclick="boardregister()"
					style="background-color: #1c1637; border: none; font-family: 배달의민족 주아; color: white; float: right;">새
					글 작성 </a>
			</c:if>
		...
		<table class="table table-hover;">
			...
			<tbody style="background: white; opacity: 0.6;">
				<c:forEach var="board" items="${boardList}">
					<tr>
						<td>${board.bno}</td>
						<td><a href="boarddetail?bno=${board.bno}">${board.title}</a>
						</td>
						<td>${board.userid}</td>

						<td><fmt:formatDate var="regdate" value="${board.regdate}"
								pattern="yyyy/MM/dd HH:mm" />${regdate}</td>
					</tr>
				</c:forEach>
